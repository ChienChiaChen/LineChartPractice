package chiachen.example.com.chartpractice.LineUtil.view;
...
import chiachen.example.com.chartpractice.LineUtil.animation.ChartAnimationListener;
import chiachen.example.com.chartpractice.LineUtil.animation.ChartDataAnimator;
import chiachen.example.com.chartpractice.LineUtil.animation.ChartDataAnimatorV14;
import chiachen.example.com.chartpractice.LineUtil.animation.ChartDataAnimatorV8;
import chiachen.example.com.chartpractice.LineUtil.animation.ChartViewportAnimator;
import chiachen.example.com.chartpractice.LineUtil.animation.ChartViewportAnimatorV14;
import chiachen.example.com.chartpractice.LineUtil.animation.ChartViewportAnimatorV8;
import chiachen.example.com.chartpractice.LineUtil.computator.ChartComputator;
import chiachen.example.com.chartpractice.LineUtil.gestire.ChartTouchHandler;
import chiachen.example.com.chartpractice.LineUtil.gestire.ContainerScrollType;
import chiachen.example.com.chartpractice.LineUtil.gestire.ZoomType;
import chiachen.example.com.chartpractice.LineUtil.listener.ViewportChangeListener;
...
import chiachen.example.com.chartpractice.LineUtil.renderer.AxesRenderer;
import chiachen.example.com.chartpractice.LineUtil.renderer.ChartRenderer;
...
public abstract class AbstractChartView extends View implements Chart {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (isInteractive) {
            ...
            if (needInvalidate) {
                if (chartRenderer.isTouched()) {//Ensure selected value is in point
